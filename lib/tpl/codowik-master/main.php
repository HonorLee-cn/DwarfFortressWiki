...
<body>
    ...
    <!--[if ( lte IE 7 | IE 8 ) ]></div><![endif]-->
        ...
        <h1><?php
            ...
            tpl_link(
                wl(),
                '<img style="width:135px;margin:0 auto 10px" src="'.$logo.'" '.$logoSize[3].' alt="" /> <p style="text-align:center">'.$conf['title'].'</p>',
                'accesskey="h" title="[H]"'
            );
        ?></h1>
        <?php if ($conf['tagline']): ?>
        ...
        <div id="dokuwiki__sitetools">
			...
			<div style="display:none">
				<script type="text/javascript">var cnzz_protocol = (("https:" == document.location.protocol) ? " https://" : " http://");document.write(unescape("%3Cspan id='cnzz_stat_icon_5787041'%3E%3C/span%3E%3Cscript src='" + cnzz_protocol + "s13.cnzz.com/stat.php%3Fid%3D5787041%26show%3Dpic' type='text/javascript'%3E%3C/script%3E"));</script>
			</div>
        </div>
    ...
    document.write(unescape("%3Cscript src='" + _bdhmProtocol + "hm.baidu.com/h.js%3F45841ba859ca2e8d631377729b1cc1fb' type='text/javascript'%3E%3C/script%3E"));
    </script></div>
